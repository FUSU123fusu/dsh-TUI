...
import { ensureSharedSessionImported, listSharedSessions, sameCwd, type ImportablePersistence } from './sharedSessions.js'
    ...
    async listSessions() {
      ...
      try {
        ...
        for (const shared of listSharedSessions()) {
          if (known.has(shared.id) || !sameCwd(shared.cwd, cwd)) continue
          visible.push({
